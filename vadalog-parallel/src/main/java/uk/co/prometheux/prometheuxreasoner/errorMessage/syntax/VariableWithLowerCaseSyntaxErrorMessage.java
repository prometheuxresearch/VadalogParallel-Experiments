...
public class VariableWithLowerCaseSyntaxErrorMessage implements ErrorMessage {
	...
	public VariableWithLowerCaseSyntaxErrorMessage(int lineNumber, int columnNumber) {
