...
public class BindAnnotationErrorMessage implements AnnotationErrorMessage {
	...
	public BindAnnotationErrorMessage() {}
	
	public BindAnnotationErrorMessage(Atom bind) {
		vadalogProgramAsRuleList = SyntaxErrorMessageIdentifier.getVadalogProgramAsList();
		this.lineNumber = this.getRuleLineFromAtom(bind);
		String wrongString = bind.getName();
		this.columnNumber = bind.toClauseString().indexOf(wrongString);
