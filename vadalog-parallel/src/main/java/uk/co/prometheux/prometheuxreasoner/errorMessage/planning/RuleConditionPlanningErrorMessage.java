...
/**
 * This Class is an error message for rule condition planning
 * 
 * 
...
public class RuleConditionPlanningErrorMessage implements PlanningErrorMessage {
	...
	public RuleConditionPlanningErrorMessage() {
