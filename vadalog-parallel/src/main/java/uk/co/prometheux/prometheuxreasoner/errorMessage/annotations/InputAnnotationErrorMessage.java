...
public class InputAnnotationErrorMessage implements AnnotationErrorMessage {
	...
	public InputAnnotationErrorMessage() {}
	
	public InputAnnotationErrorMessage(Atom input) {
